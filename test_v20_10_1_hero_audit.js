...
assert.equal(seed.metadata.version,'0.20.10.1');
assert.equal(seed.spots.length,446);
...
const index=fs.readFileSync('index.html','utf8'); assert(index.includes('data.js?v=20101'));
