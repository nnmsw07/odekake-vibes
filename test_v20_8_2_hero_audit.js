...
const auditFile=['0.20.10.1','0.20.11.0'].includes(seed.metadata.version)?'HERO_OVERRIDES_v20_10_1.json':'HERO_OVERRIDES_v20_8_2.json';
const audit=JSON.parse(fs.readFileSync(auditFile,'utf8'));
const byId=Object.fromEntries(seed.spots.map(s=>[s.spot_id,s]));
assert.ok(['0.20.8.2','0.20.10.0','0.20.10.1','0.20.11.0'].includes(seed.metadata.version));
...
assert.ok(data.includes('\"version\": \"0.20.8.2\"')||data.includes('\"version\": \"0.20.10.0\"')||data.includes('\"version\": \"0.20.10.1\"')||data.includes('\"version\": \"0.20.11.0\"'));
const index=fs.readFileSync('index.html','utf8');
assert.ok(index.includes('data.js?v=2082')||index.includes('data.js?v=20100')||index.includes('data.js?v=20101')||index.includes('data.js?v=20110'));
