...
assert.equal(seed.spots.length,256);assert.ok(/^0\.19\.7(?:\.\d+)?$/.test(seed.metadata.version));assert.ok(edited.length>=10);
...
console.log('V19.7.1 EDITORIAL PASS: 256 spots + 10 editorial stories + home magazine layer');
