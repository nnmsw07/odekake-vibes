...
assert.equal(seed.spots.length,286);assert.ok(/^0\.19\.(?:7(?:\.\d+)?|8(?:\.\d+)?)$/.test(seed.metadata.version));assert.ok(edited.length>=10);
...
console.log('V19.7.1 EDITORIAL PASS: 286 spots + 10 editorial stories + home magazine layer');
