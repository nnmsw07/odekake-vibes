...
const idx=read('index.html');assert.ok(Math.max(idx.indexOf('affiliate.js?v=2050'),idx.indexOf('affiliate.js?v=2060'))<idx.indexOf('aml.valuecommerce.com/vcdal.js'),'seed anchors mount before LinkSwitch loader');assert.ok(/var vc_pid = "892690966"/.test(idx));
