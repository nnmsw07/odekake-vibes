...
const idx=read('index.html');const m=idx.match(/affiliate\.js\?v=\d+/);assert.ok(m&&idx.indexOf(m[0])<idx.indexOf('aml.valuecommerce.com/vcdal.js'),'seed anchors mount before LinkSwitch loader');assert.ok(/var vc_pid = "892690966"/.test(idx));
