...
for(let i=126;i<=286;i++) assert.ok(seed.spots.some(s=>s.spot_id===`spot_${String(i).padStart(3,'0')}`));
for(const name of [
...
console.log('V19.3 PASS: 286 spots + recommendation-group diversity + age hard filter');
