...
const index=fs.readFileSync('index.html','utf8');assert.ok(index.includes('KIBUN MAGAZINE'));assert.ok(index.includes('mobile-bottom-nav'));assert.ok(/\d+スポット/.test(index));
