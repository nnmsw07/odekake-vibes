...
const seed=sandbox.window.ODEKAKE_SEED;assert.ok(seed.spots.length>=291);
...
const app=fs.readFileSync('app.js','utf8');assert(app.includes("['stage','観劇・舞台']"));assert(app.includes('renderExperienceFeatures'));assert(app.includes('予約推奨'));
...
console.log('V19.7.2 Experience PASS: 291 spots + 15 curated experiences + stage browse-only + editorial feature section');
