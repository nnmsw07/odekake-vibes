...
const seed=sandbox.window.ODEKAKE_SEED;assert.equal(seed.spots.length,256);
...
console.log('V19.7.2 Experience PASS: 256 spots + 15 curated experiences + stage browse-only + editorial feature section');
