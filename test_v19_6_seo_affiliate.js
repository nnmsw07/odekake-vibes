...
ok(['0.19.6','0.19.7'].includes(seed.metadata.version),'version');
ok(seed.spots.length===241,'241 spots');
...
console.log('V19.6 REGRESSION PASS: 20 SEO guides + 241 monetization grades + affiliate foundation retained');
