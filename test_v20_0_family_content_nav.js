...
const site=fs.readFileSync('sitemap.xml','utf8');assert.ok(site.includes('/magazine/oyako-rest-indoor/'));assert.ok(!site.includes('/magazine/shibuya-with-kids/'));assert.ok(!site.includes('/magazine/shinjuku-family-day/'));assert.ok(site.includes('/magazine/japanese-culture-experience/')); 
console.log('V20.0 PASS: family content + 4-tab nav + article/plan separation + editorial hero art');
