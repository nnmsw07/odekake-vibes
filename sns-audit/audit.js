(function(){
  ...
  function captureSlideHtml(slide,idx,total,source,imageMode){
    ...
    if(slide.kind==='article-poster'){
      return `<section class="capture-item capture-item-poster"><a class="ig-poster-link" href="${esc(slide.image)}" target="_blank" rel="noopener" aria-label="1枚目を原寸で開く"><img class="ig-poster-image" src="${esc(slide.image)}" alt="${esc(slide.title)}" loading="eager"></a></section>`;
    }
    if(slide.kind==='article-spots'){
