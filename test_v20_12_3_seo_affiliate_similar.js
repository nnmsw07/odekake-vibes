...
assert.strictEqual(seed.spots.length,473,'spot count must be 473');
...
assert.strictEqual(routes.length,473,'SEO route count mismatch');
...
assert(index.includes('関東＋伊豆473スポット'));
assert(index.includes('data.js?v=201240'));
assert(index.includes('affiliate-config.js?v=201240'));
assert(index.includes('app.js?v=201125&amp;h=201240'));
assert(index.includes('styles.css?v=201125&amp;h=201240'));
