...
for(const f of ['data.js?v=2051','plans.js?v=2040']) assert.ok(root.includes(f),`cache key missing ${f}`); assert.ok(/app\.js\?v=(?:2050|2060)/.test(root),'app cache key missing');
