...
assert.ok(/data\.js\?v=(?:2051|2061|2070|2080|2081|2082|20100|20101|20110)/.test(root));assert.ok(/plans\.js\?v=(?:2040|20100|20101|20110)/.test(root));assert.ok(/app\.js\?v=(?:2050|2061|2063|2070|2080|2081|2090|2091)/.test(root));
const hub=fs.readFileSync('magazine/index.html','utf8');
assert.ok(/magazine-media\.js\?v=(?:2033|2040|2102|2103|2110|2113)/.test(hub));
const reps={
...
for(const [slug,id] of Object.entries(reps)){
  ...
  assert.ok(/magazine-media\.js\?v=(?:2033|2064|2102|2103|2110|2113)/.test(a),`article resolver missing ${slug}`);
}
