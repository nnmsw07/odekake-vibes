...
assert.ok(/magazine-media\.js\?v=(?:2033|2040|2102|2103|2110)/.test(hub));
const reps={
...
for(const [slug,id] of Object.entries(reps)){
  ...
  assert.ok(/magazine-media\.js\?v=(?:2033|2064|2102|2103|2110)/.test(a),`article resolver missing ${slug}`);
}
