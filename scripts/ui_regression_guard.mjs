...
const checks = [
  ...
  ['Hero Audit spot detail uses the full mobile viewport and hides the dock while open', styles.includes('v20.19.13 — Hero Audit mobile detail uses the viewport') && styles.includes('max-height:calc(100dvh - 16px)') && styles.includes('.hero-audit-mode.hero-audit-spot-open .hero-audit-dock') && heroGuard.includes('installHeroAuditSpotOpenState') && heroGuard.includes("classList.toggle('hero-audit-spot-open'")],
