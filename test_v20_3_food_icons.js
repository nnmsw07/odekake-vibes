...
const idx=fs.readFileSync('index.html','utf8');assert.ok(idx.includes('assets/nav/spot.svg'));assert.ok(!idx.includes('assets/nav/spot.png'));assert.ok(/(?:317|320|324)スポット/.test(idx));
