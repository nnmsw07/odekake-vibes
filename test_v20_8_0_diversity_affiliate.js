...
assert(['0.20.8.0','0.20.8.1','0.20.8.2'].includes(seed.metadata.version));
...
const idx=fs.readFileSync(__dirname+'/index.html','utf8');assert(idx.includes('431スポット'));assert(/data\.js\?v=(?:2080|2081|2082)/.test(idx));assert(/affiliate-config\.js\?v=(?:2080|2090|2091)/.test(idx));
