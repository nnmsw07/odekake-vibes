...
assert(['0.20.8.0','0.20.8.1','0.20.8.2','0.20.10.0','0.20.10.1','0.20.11.0'].includes(seed.metadata.version));
...
const idx=fs.readFileSync(__dirname+'/index.html','utf8');assert(/(?:431|446|458)スポット/.test(idx));assert(/data\.js\?v=(?:2080|2081|2082|20100|20101|20110)/.test(idx));assert(/affiliate-config\.js\?v=(?:2080|2090|2091|20100|20101|20110)/.test(idx));
