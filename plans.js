(function(root,factory){
  ...
  const CURATED_PLANS=[
    ...
    {id:'dog_yokohama_seaside_halfday',aud:['dog'],min:180,max:360,vibes:['waterside','stroll','relax','food'],spots:['spot_084','spot_085','spot_086'],labels:['港を歩く','海辺で寄り道','テラスでひと休み'],title:'わんこと横浜、海辺を歩く半日。',lead:'赤レンガからMARINE & WALK、ハンマーヘッドへ。移動を増やさず、港の景色とテラスの時間をゆるくつなぐ。'},
    {id:'dog_grandberry_easy',aud:['dog'],min:180,max:360,vibes:['shopping','stroll','food','relax'],spots:['spot_139'],labels:['買い物と散歩'],title:'買い物も散歩も。南町田で気楽な犬連れ休日。',lead:'ペット向け設備が揃うグランベリーパークを主役に。鶴間公園まで含めて、一つの街の中で無理なく過ごす。'},
    {id:'dog_sagamiko_full_day',aud:['dog'],min:360,max:600,vibes:['nature','active','extraordinary'],spots:['spot_470'],labels:['犬と一緒に遊ぶ'],title:'今日は全力で遊ぶ。わんこと相模湖一日プラン。',lead:'さがみ湖MORI MORIを一日の目的地に。ドッグランや犬同伴アトラクションの条件を確認して、犬も人もちゃんと遊ぶ。'},
    {id:'dog_metsa_lakeside',aud:['dog'],min:300,max:540,vibes:['nature','waterside','stroll','relax'],spots:['spot_094','spot_122'],labels:['湖と森を歩く','物語の景色へ'],title:'森と湖へ。メッツァでわんこと過ごす一日。',lead:'メッツァビレッジで湖畔を歩き、ムーミンバレーパークへ。屋内施設の同伴条件を確認しながら、景色を主役にする。'},
    {id:'dog_gora_garden',aud:['dog'],min:180,max:360,vibes:['nature','scenic','relax','culture'],spots:['spot_471'],labels:['庭園を散歩'],title:'箱根で、わんこと庭園を歩く午後。',lead:'強羅公園をゆっくり散策。屋内施設には入れないぶん、花や噴水、山の空気を楽しむ時間としてシンプルに。'},
    ...
    {id:'friends_shinjuku_rooftop_evening',aud:['friends','partner'],min:240,max:420,vibes:['food','scenic','extraordinary','stroll','relax'],spots:['spot_300','spot_447'],labels:['夕方の緑へ','ルーフトップで夜ごはん'],title:'緑の夕方から、屋上で夜風に変える。',lead:'新宿御苑を短く歩いたら、ヒルトン東京のルーフトップへ。昼から詰め込まず、夕方から一日を始める。',availability_note:'2026年ビアガーデンは9月30日まで。雨天・強風時は営業状況を確認。'},
    {id:'partner_ikebukuro_aqua_night',aud:['partner','friends','solo'],min:180,max:330,vibes:['animals','scenic','extraordinary','cool','relax'],spots:['spot_450','spot_451'],labels:['夜の水族館へ','空の上で夜景'],title:'水の中を見たあと、空の上で夜景を見る。',lead:'サンシャイン水族館から、同じ街区のてんぼうパークへ。夕方から二つだけ、景色の高さを変えていく池袋の夜。'},
    {id:'family_minatomirai_play_247',aud:['family'],min:210,max:360,vibes:['active','food','relax','scenic'],spots:['spot_007','spot_454'],labels:['子どもの時間','親も座ってごはん'],title:'遊び切ったら、観覧車を見ながらちゃんと食べる。',lead:'MARK ISで子どもの遊び時間をつくったら、みなとみらい東急スクエアの24/7 restaurantへ。移動を増やさず、最後は親も座る。'},
    {id:'family_motomachi_pignic_walk',aud:['family','partner'],min:150,max:300,vibes:['animals','stroll','relax','food'],spots:['spot_455','spot_140'],labels:['こぶたと過ごす','元町を少し歩く'],title:'こぶたと遊んだあと、元町を少しだけ歩く。',lead:'pignic cafeの個室でマイクロブタと過ごしたら、元町ショッピングストリートへ。体験を主役にして、街歩きは余裕がある分だけ。'},
    {id:'family_miura_harvest_soleil',aud:['family','friends','partner'],min:300,max:480,vibes:['nature','food','creative','active','scenic'],spots:['spot_458','spot_046'],labels:['季節を収穫する','外で遊ぶ'],title:'畑で季節を持ち帰って、丘の上でもう少し遊ぶ。',lead:'津久井浜観光農園でその時期の収穫体験をしたら、ソレイユの丘へ。三浦半島の外の日を、移動しすぎず一日にまとめる。'},
    {id:'stage_hatsudai_ballet',aud:['partner','solo','friends'],min:150,max:300,vibes:['culture','extraordinary','relax'],spots:['spot_479'],labels:['舞台を主役にする'],title:'今日は、バレエを観るために出かける。',lead:'新国立劇場の公演を一日の主役に。前後を詰め込みすぎず、舞台の余韻まで含めて過ごす。',allow_browse_only:true},
    {id:'stage_shibuya_orb_sky',aud:['partner','friends','solo'],min:300,max:480,vibes:['culture','extraordinary','scenic'],spots:['spot_481','spot_113'],labels:['舞台を観る','夜景へ上がる'],title:'舞台のあと、渋谷の空へ。',lead:'東急シアターオーブで物語に入ったあと、SHIBUYA SKYへ。観劇の余韻を、街の景色までつなげる。',allow_browse_only:true},
    {id:'stage_yokohama_kaat_harbor',aud:['partner','solo','friends'],min:360,max:540,vibes:['culture','stroll','waterside','food'],spots:['spot_245','spot_103','spot_257'],labels:['舞台を観る','港を歩く','余韻を残す'],title:'KAATのあと、港を歩いてもう少し。',lead:'舞台を観たら山下公園へ。そのままTHE WHARF HOUSEで座って、終演後の余韻を急がず楽しむ。',allow_browse_only:true},
    {id:'stage_yokohama_classical_art',aud:['partner','solo','friends'],min:360,max:600,vibes:['culture','scenic','food'],spots:['spot_485','spot_101','spot_259'],labels:['音楽を聴く','アートを見る','港で食事'],title:'音楽とアート、最後は赤レンガへ。',lead:'みなとみらいホールと横浜美術館を同じ日に。最後はbillsで座って、文化の日を港の景色でほどく。',allow_browse_only:true},
    {id:'stage_ikebukuro_theatre_park',aud:['partner','solo','friends'],min:300,max:480,vibes:['culture','stroll','food','relax'],spots:['spot_480','spot_180','spot_346'],labels:['舞台を観る','外の空気へ','ごはんで締める'],title:'劇場を出たら、公園を通ってごはんへ。',lead:'東京芸術劇場を主役に、池袋西口公園で少し外の空気を。時間に余裕があればEAT GOOD PLACEまでつなぐ。',allow_browse_only:true},
    {id:'stage_ginza_kabuki_art',aud:['partner','solo','friends'],min:240,max:420,vibes:['culture','extraordinary','stroll'],spots:['spot_242','spot_151'],labels:['歌舞伎を観る','もう一つの美術へ'],title:'歌舞伎のあと、銀座でもう一つの美術。',lead:'歌舞伎座を主役にした日は、近くのアートアクアリウムへ。伝統と現代の見せ方を、同じ銀座で楽しむ。',allow_browse_only:true},
    {id:'stage_ariake_musical_smallworlds',aud:['family','partner','friends'],min:300,max:480,vibes:['culture','extraordinary','creative'],spots:['spot_489','spot_029'],labels:['ミュージカルを観る','小さな世界へ'],title:'ミュージカルの日、有明でもう一つ遊ぶ。',lead:'有明四季劇場の公演を主役に、スモールワールズを組み合わせる。親子でも友だち同士でも、非日常を一日にまとめる。',allow_browse_only:true},
    {id:'stage_billboard_hammerhead',aud:['partner','friends','solo'],min:300,max:600,vibes:['culture','food','waterside','stroll'],spots:['spot_488','spot_086','spot_373'],labels:['ライブを楽しむ','港へ出る','甘い余韻を'],title:'ライブのあと、ハンマーヘッドまで歩く。',lead:'Billboard Live YOKOHAMAを楽しんだら、港側へ。横浜ハンマーヘッドとVANILLABEANSで、夜をすぐ終わらせない。',allow_browse_only:true}
  ...
  function curatedPlanPreview(seed,id){
    ...
    if(typeof hardFilterReason==='function'&&spots.some(s=>hardFilterReason(s,{audience,currentDate:new Date(),allowOvernight:overnight,includeBrowseOnly:bp.allow_browse_only===true})))return null;
  ...
  function curatedPlanForPrimary(seed,primary,r,ctx,displayMinutes,used,allPrimaryIds){
    ...
    for(const bp of choices){
      ...
      return{plan_id:`plan_${r.slot||primary.spot_id}_${bp.id}`,slot:r.slot,slot_label:r.slot_label,score:Number(r.scores?.overall||70),travel_minutes:r.travel_minutes??null,why:r.why||[],primary_spot_id:primary.spot_id,requested_minutes:displayMinutes,type:overnight?'overnight':(spots.length===1?'single':'combo'),duration_label:overnight?'1泊プラン':requestedDurationLabel(displayMinutes),estimated_minutes:overnight?null:total,title:bp.title,lead:bp.lead,spot_ids:spots.map(s=>s.spot_id),steps:curatedSteps(bp,spots),curated:true,curated_id:bp.id,availability_note:bp.availability_note||null};
    }
    return null;
  }
