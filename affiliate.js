(function(){
  ...
  function allLinksFor(spot){
    ...
    return manual.concat(source).sort((a,b)=>rankLink(a,intent)-rankLink(b,intent));
  }
  ...
  window.KibunAffiliate={intentFor,allLinksFor,linksFor,sourceLinksFor,linkSwitchReady,mountLinkSwitchSeeds,render};
})();
